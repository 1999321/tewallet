...
//             return fallback();
//         }
//         throw new Error(`Url host is not supported: ${url}`);
//     }
...
//         const window = getWindow();
//         if (!window) {
//             throw new Error(`Can't post event to parent window: window is not defined`);
//         }
...
//         } else {
//             throw new Error(`Can't post event to TMA`);
//         }
//     } catch (e) {
...
export function versionAtLeast(ver: string): boolean {
